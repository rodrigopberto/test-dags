...
with DAG('windog_test' default_args=default_args,catchup=False,schedule_interval=timedelta(hours=19),max_active_runs=1) as dag:
    t1 = BashOperator(
        task_id='print_date1',
        bash_command='date')
    ...
    t2_1 = PythonOperator(
        ...
        op_kwargs={
            'image_name': 'rodrigocver/windog_test:latest',
            'my_id': t2_1_id
        },
